        ...
        // console.log(`name:`, firstname , `last name:`, LastName).Uppercase;
        // console.log(`my fullname are : ${FullName.length}` );
...
function run(){
    ...
    document.getElementById('operator_output').innerHTML = output
